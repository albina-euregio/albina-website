...
export class ConstantsService {
  ...
  public textcatUrl: string = 'https://admin.avalanche.report/textcat/c_pm.html';
  public chatUrl: string = 'wss://socket.avalanche.report:80/albina/chat/';
  public bulletinUrl: string = 'wss://socket.avalanche.report:80/albina/bulletin/';
  public updateUrl: string = 'wss://socket.avalanche.report:80/albina/update/';
  public regionUrl: string = 'wss://socket.avalanche.report:80/albina/region/';
