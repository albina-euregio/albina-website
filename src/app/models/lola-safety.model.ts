...
export function toLoLaTable(report: AvalancheReport, t: (key: string) => string): ObservationTableRow[] {
  return [
    ...
    { label: t("LoLaAvalanchePotential.avalancheSize"), value: report.avalanchePotential.avalancheSize },
    { label: t("LoLaAvalanchePotential.avalancheType"), value: report.avalanchePotential.avalancheType },
    ...
    { label: t("LoLaAvalanchePotential.comment"), value: report.avalanchePotential.comment },
