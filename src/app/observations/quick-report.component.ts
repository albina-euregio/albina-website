...
export class QuickReportComponent {
  	...
  	private translateService: TranslateService)
  {
	...
	getSnowConditionsString() {
		let result = "";
		for (var i = this.quickReport.snowConditions.length - 1; i >= 0; i--) {
	...
	getRodeString() {
		let result = "";
		for (var i = this.quickReport.rode.length - 1; i >= 0; i--) {
	...
	getAvoidedString() {
		let result = "";
		for (var i = this.quickReport.avoided.length - 1; i >= 0; i--) {
