...
//------------------------------------------------------------------------------------------------
	...
	function expand(div) {
		$(div).removeClass('tch');
		$('<img src="'+contextPath+'images/text_ok.png" onclick="PM.collapse(this.parentNode)">').appendTo(div);
		$('<img src="'+contextPath+'images/text_find.png" onclick="PM.openDialog(this.parentNode)">').appendTo(div);
		$('<img src="'+contextPath+'images/garbage.png" class="trash">').appendTo(div);
		$("p", div).remove();
