...
L.timeDimension.layer.imageLayer = function(layer, options) {
...
L.TimeDimension.Layer.ImageLayer.Albina = L.TimeDimension.Layer.ImageLayer.extend(
  {
    ...
    eachLayer: function(method, context) {
      ...
      return L.TimeDimension.Layer.ImageLayer.prototype.eachLayer.call(
        this,
        method,
        context
      );
    ...
    setOpacity: function(opacity) {
      L.TimeDimension.Layer.ImageLayer.prototype.setOpacity.apply(
        this,
        arguments
      );
      ...
      for (var prop in this._layers) {
        if (
          this._layers.hasOwnProperty(prop) &&
          this._layers[prop].setOpacity
        ) {
    ...
    setZIndex: function(zIndex) {
      L.TimeDimension.Layer.ImageLayer.prototype.setZIndex.apply(
        this,
        arguments
      );
      // apply to all preloaded caches
    ...
    _removeLayers: function(times) {
      for (var i = 0, l = times.length; i < l; i++) {
        if (this._map) this._map.removeLayer(this._layers[times[i]]);
