...
export default class ExpositionIcon extends React.Component {
  ...
  constructor(props) {
    ...
    this.imgRoot = '../../images/pro/expositions/';
    this.alts = {
      'n': 'North',
      'ne': 'North East',
      'e': 'East',
  ...
  render() {
    ...
    const backgroundEntries = Object.entries(this.alts).map((e) =>
      <img className={"expo_" + e[0]} src={this.imgRoot + 'exposition_' + e[0] + '.png'} alt={this.alts[e[0]]}/>
    );
    console.log('TEST: ' + JSON.stringify(classes));
    return (
