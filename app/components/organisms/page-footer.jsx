          ...
          <div className="grid">
            <div className="grid-item normal-6">
              ...
              <ul className="list-plain footer-navigation footer-navigation-main">
                <li><a href="#" className=" " title>Avalanche Bulletin <small>Home</small></a></li>
                <li><a href="#" className=" has-sub" title>Snow &amp; Weather</a></li>
                <li><a href="#" className=" has-sub" title>Education &amp; Prevention</a></li>
                <li><a href="#" className title>Blog</a></li>
            ...
            <div className="grid-item all-12">
              <p className="page-footer-top">
                <a href="#page-main" className="icon-arrow-up" title="Top" data-scroll><span>Top</span></a>
              </p>
            </div>
          </div>
        </section>
        <section className="section section-padding page-footer-sm-follow">
