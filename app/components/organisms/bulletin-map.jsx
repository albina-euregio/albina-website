          ...
          <div className="bulletin-map-zoom">
            <ul className="list-plain">
              <li className="bulletin-map-zoom-plus">
                <button href="#" className="pure-button pure-button-icon icon-plus-big tooltip" title="Zoom in"><span>&nbsp;</span></button>
              </li>
              <li className="bulletin-map-zoom-minus">
                <button href="#" className="pure-button pure-button-icon icon-minus-big tooltip" title="Zoom out"><span>&nbsp;</span></button>
              </li>
            </ul>
          </div>
          <div className="bulletin-map-details js-active top-right">
            <ul className="list-plain">
              <li className="bulletin-report-picto tooltip" title="Above 1800m: Warning Level 3<br/>Below 1800m: Warning Level 2">
                <img src="../../images/pro/warning-pictos/levels_2_3.png" alt="Warning Levels 2 and 3" />
                <span>1800m</span>
              </li>
              <li className="bulletin-report-picto tooltip" title="Drifting Snow">
              ...
              <li className="bulletin-report-picto tooltip" title="Old Snow">
                <img src="../../images/pro/avalanche-situations/old_snow.png" alt="DrifOldting Snow" />
              </li>
            </ul>
            <a href="#section-bulletin-report" className="pure-button tooltip" title="See full bulletin report" data-scroll><span>Click for</span> Details<span className="icon-arrow-down" /></a>
          </div>
        </div>
      </section>
    );
