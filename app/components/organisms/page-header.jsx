          ...
          <ul className="list-plain navigation">
            ...
            <li>
              ...
              <ul className="list-plain subnavigation">
                ...
                <li><a href="#" className title>Progonosekarten</a></li>
                <li><a href="#" className title>Wetterstationen</a></li>
                <li><a href="#" className title>Schneeprofile</a></li>
                <li><a href="#" className title>Unfälle</a></li>
                <li><a href="#" className title>Webcams</a></li>
              </ul>
            </li>
            <li>
              ...
              <ul className="list-plain subnavigation">
                ...
                <li><a href="#" className title>Lawinenprobleme</a></li>
                <li><a href="#" className title>Gefahrenmuster</a></li>
                <li><a href="#" className title>Lawinengrößen</a></li>
                <li><a href="#" className title>Geländeneigungen</a></li>
                <li><a href="#" className title>Glossar</a></li>
