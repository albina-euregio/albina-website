  ...
  render() {
    ...
    const elevation =
      (this.props.fullBulletin.hasElevationDependency && !this.props.fullBulletin.treeline)
        ...
        : null;
    const treeline = this.props.fullBulletin.hasElevationDependency && this.props.fullBulletin.treeline;

    const tendency = this.props.fullBulletin.tendency;
    const tendencyTitle = tendency
      ? this.props.intl.formatMessage({id: 'bulletin:report:tendency:' + tendency})
        ...
        <div className="bulletin-report-pictobar">
          <div className="bulletin-report-region">
            <a href="#page-main"
              ...
              data-scroll="" >
              <BulletinAWMapStatic store={this.props.store} bulletin={this.props.fullBulletin} ampm={this.props.ampm} />
            </a>
          </div>
