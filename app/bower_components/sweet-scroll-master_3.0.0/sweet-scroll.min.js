...
!(function(t, e) {
  ...
  var t =
    ...
    s = e ? window.requestAnimationFrame.bind(window) : null,
    ...
    g = {
      ...
      easeInSine: function(t, e, n, o, i) {
        return -o * f((e / i) * (v / 2)) + o + n
      },
      easeOutSine: function(t, e, n, o, i) {
        return o * h((e / i) * (v / 2)) + n
      },
      easeInOutSine: function(t, e, n, o, i) {
        return (-o / 2) * (f((v * e) / i) - 1) + n
      },
      ...
      easeInCirc: function(t, e, n, o, i) {
        return -o * (d(1 - (e /= i) * e) - 1) + n
      },
      easeOutCirc: function(t, e, n, o, i) {
        return o * d(1 - (e = e / i - 1) * e) + n
      },
    ...
    $ = function(t) {
      return M(t).shift() || null
    },
    E = function(t, e) {
      if (a(e)) return t === e
      for (var n = M(e), o = n.length; --o >= 0 && n[o] !== t; );
      return o > -1
    },
    C = function(t) {
      ...
      for (
        ...
        if (l[n] > 0) u = l
          ...
          var s = window.outerWidth,
            c = window.innerWidth,
            f = s ? s / c : 1
          ;(i.style.width = l.clientWidth + 1 + 'px'),
            (i.style.height = l.clientHeight + 1 + 'px'),
            l.appendChild(i),
            (l[n] = Math.max(1, 1.5 / f)),
            l[n] > 0 && (u = l),
            (l[n] = 0),
            l.removeChild(i)
        }
    ...
    W = function(t, e, n, o) {
      L(t, 'addEventListener', e, n, o)
    },
    z = function(t, e, n, o) {
      L(t, 'removeEventListener', e, n, o)
    },
    H = /^(\+|-)=(\d+(?:\.\d+)?)$/,
    j = function(e, n) {
      var o,
        r = { top: 0, left: 0, relative: !1 }
      if (u(e, 'top') || u(e, 'left')) r = t({}, r, e)
      else if (l(e))
      ...
      else if (!l((o = e)) && o - parseFloat(o) + 1 >= 0)
        n ? (r.top = e) : (r.left = e)
      else {
        if (!i(e)) return null
        var a = e.trim().match(H)
        if (!a) return null
        var s = a[1],
          c = parseInt(a[2], 10)
        '+' === s
          ? ((r.top = n ? c : 0), (r.left = n ? 0 : c))
          : ((r.top = n ? -c : 0), (r.left = n ? 0 : -c)),
          (r.relative = !0)
      }
      return r
  ...
  return (function() {
    function o(n, i) {
        ...
        (this.loop = function(t) {
          ...
          if ((i.start || (i.start = t), i.progress && n)) {
            ...
            Object.keys(a).forEach(function(t) {
              ...
              if (0 !== i) {
                var r = c(d, f * d, 0, 1, f)
                b(n, Math.round(o + i * r), h[t])
              }
            }),
              p <= f
                ? (r.hook(l, 'step', d), (i.id = o.raf(r.loop)))
                : r.stop(!0)
          } else r.stop()
        }),
        (this.handleClick = function(e) {
          for (
            var n = r.opts, o = e.target;
            o && o !== document;
            o = o.parentNode
          )
            if (E(o, n.trigger)) {
              var i = JSON.parse(
                  o.getAttribute('data-scroll-options') || '{}'
                ),
                l =
                  o.getAttribute('data-scroll') ||
                  o.getAttribute('href'),
                a = t({}, n, i),
                u = a.preventDefault,
                s = a.stopPropagation,
      ...
      var l = t({}, q, n || {}),
        a = l.vertical,
        u = l.horizontal,
        s = void 0 === i ? 'body,html' : i,
        c = null
      e && (a && (c = I(s, 'y')), !c && u && (c = I(s, 'x'))),
        c && ((this.opts = l), (this.$el = c), this.bind(!0, !1))
    }
    return (
      ...
      (o.prototype.to = function(n, o) {
        if (e) {
          var r = this.$el,
            ...
            h = c.vertical,
            p = c.horizontal,
            d = a(c.header) ? c.header : $(c.header),
            v = i(n) && /^#/.test(n) ? n : null
          if (
            ((l.opts = c),
            (l.cancel = !1),
            ...
            if (m)
              if (m.relative) {
                var y = x(r, h ? 'y' : 'x')
                ;(w.top = h ? y + m.top : m.top),
                  (w.left = h ? m.left : y + m.left)
              } else w = m
            else if (i(n) && '#' !== n) {
              var b = $(n)
              if (!b) return
            ...
            g && ((w.top += g.top), (w.left += g.left)),
              d && (w.top = Math.max(0, w.top - A(d).height))
            var M = P(r),
              E = M.viewport,
              C = M.size
            ;(w.top = h
              ? Math.max(0, Math.min(C.height - E.height, w.top))
              : x(r, 'y')),
              (w.left = p
                ? Math.max(0, Math.min(C.width - E.width, w.left))
                : x(r, 'x')),
              !1 !== this.hook(c, 'before', w, s)
                ? ((l.pos = w), this.start(c), this.bind(!1, !0))
                : (l.opts = null)
          }
        }
      }),
      (o.prototype.toTop = function(e, n) {
        this.to(e, t({}, n || {}, { vertical: !0, horizontal: !1 }))
      }),
      (o.prototype.toLeft = function(e, n) {
        this.to(e, t({}, n || {}, { vertical: !1, horizontal: !0 }))
      }),
      ...
      (o.prototype.destroy = function() {
        this.$el &&
          (this.stop(), this.unbind(!0, !0), (this.$el = null))
      }),
      (o.prototype.onBefore = function(t, e) {
        return !0
      }),
      (o.prototype.onStep = function(t) {}),
      (o.prototype.onAfter = function(t, e) {}),
      ...
      (o.prototype.start = function(t) {
        ...
        ;(e.opts = t),
          (e.progress = !0),
          (e.easing = r(t.easing) ? t.easing : g[t.easing])
        var n = this.$el,
          i = e.pos,
          l = { top: x(n, 'y'), left: x(n, 'x') }
        if (t.quickMode) {
          var a = P(n).viewport,
            u = a.width,
            s = a.height
          Math.abs(l.top - i.top) > s &&
            (l.top = l.top > i.top ? i.top + s : i.top - s),
            Math.abs(l.left - i.left) > u &&
              (l.left = l.left > i.left ? i.left + u : i.left - u)
        }
        ;(e.startPos = l), (e.id = o.raf(this.loop))
      }),
        ...
        if (t && l) {
          if (null != i && i !== window.location.hash) {
            ...
            e &&
              ...
              !1 !== s &&
              window.history[
                'replace' === s ? 'replaceState' : 'pushState'
              ](null, '', i)
          }
          this.unbind(!1, !0),
            (o.opts = null),
            (o.$trigger = null),
            r ? this.hook(l, 'cancel') : this.hook(l, 'after', a, u),
            this.hook(l, 'complete', r)
        }
      }),
      (o.prototype.hook = function(t, e) {
        ...
        var i,
          ...
          a = t[e]
        return (
          r(a) && (i = a.apply(this, n.concat([this]))),
          (l = this['on' + (e[0].toUpperCase() + e.slice(1))].apply(
            this,
            n
          )),
          void 0 !== i ? i : l
      ...
      (o.prototype.bind = function(t, e) {
        var n = this.$el,
          o = this.ctx.opts
        n &&
          (t && W(n, 'click', this.handleClick, !1),
          e &&
            W(
              n,
      ...
      (o.prototype.unbind = function(t, e) {
        var n = this.$el,
          o = this.ctx.opts
        n &&
          (t && z(n, 'click', this.handleClick, !1),
          e &&
            z(
              n,
              'wheel touchstart touchmove',
