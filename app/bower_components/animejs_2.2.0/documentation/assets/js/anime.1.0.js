...
(function(r, n) {
  ...
  var r = {
    ...
    F = function(a, b) {
      ...
      if ((e.node(a) || e.svg(a)) && (a.getAttribute(b) || (e.svg(a) && a[b])))
        return "attribute";
      if (!e["null"](a[b]) && !e.undef(a[b])) return "object";
    },
    x = function(a, b) {
      if (b in a.style)
        return getComputedStyle(a).getPropertyValue(A(b)) || "0";
    },
    Q = function(a, b) {
      var c = -1 < b.indexOf("scale") ? 1 : 0,
        d = a.style.transform;
      if (!d) return c;
      for (var f = /(\w+)\((.+?)\)/g, h = [], e = [], q = []; (h = f.exec(d)); )
    ...
    T = function(a, b) {
      ...
      for (d in a)
        if (!r.hasOwnProperty(d) && "targets" !== d) {
          var f = e.object(a[d]) ? w(a[d]) : { value: a[d] };
          f.name = d;
          c.push(t(f, b));
        }
      return c;
    ...
    J = function(a, b, c, d) {
      "transform" === c
        ? ((c = a + "(" + E(a, b.from, b.to) + ")"),
          (b = a + "(" + E(a, b.to) + ")"))
        : ((a = "css" === c ? x(d, a) : void 0),
          (c = H(b, b.from, a)),
          (b = H(b, b.to, a)));
      return { from: I(c), to: I(b) };
    },
    U = function(a, b) {
      var c = [];
    ...
    K = function(a) {
      ...
      a.tweens.forEach(function(a) {
        if ("css" === a.type || "transform" === a.type)
          b.push("css" === a.type ? A(a.name) : "transform"),
            a.animatables.forEach(function(a) {
              c.push(a.target);
            });
      });
      return { properties: D(b).join(", "), elements: D(c) };
    },
    W = function(a) {
      var b = K(a);
