...
export default class News extends React.Component {
  ...
  _fetchData(props) {
    Base.doRequest(
      'http://212.47.231.185:8080/albina/api/news?from=1900-01-01T01%3A00%3A00%2B01%3A00&until=2020-01-01T01%3A00%3A00%2B01%3A00',
      response => {
  ...
  _sublinks() {
    return [{ url: '2016', label: '2016' }, { url: '2017', label: '2017' }];
  }
              ...
              return (
                <article key={ni} className="message">
                  <div className="message-header">
                    <p>
                      {newItem.title.find(t => t.languageCode === 'en').text}
                    </p>
                  </div>
