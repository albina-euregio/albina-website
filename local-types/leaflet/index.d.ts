...
export class Layer extends Evented {
  ...
  // Tooltip methods
  bindTooltip(
    content: ((layer: Layer) => Content) | Content | Tooltip,
...
> extends FeatureGroup<P> {
  ...
  static geometryToLayer<
    P = any,
    G extends geojson.GeometryObject = geojson.GeometryObject
  >(featureData: geojson.Feature<G, P>, options?: GeoJSONOptions<P, G>): Layer;
  ...
  static asFeature<
    P = any,
    G extends geojson.GeometryObject = geojson.GeometryObject
  >(geojson: geojson.Feature<G, P> | G): geojson.Feature<G, P>;
...
export class Control<
  Options extends ControlOptions = ControlOptions
> extends Class {
  static extend<
    T extends object,
    Options extends ControlOptions = ControlOptions
  >(props: T): { new (...args: any[]): T } & typeof Control<Options>;
